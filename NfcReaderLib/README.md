...
|---------|---------|-------------|
| [**NfcReaderLib**](https://www.nuget.org/packages/NfcReaderLib) | 2.0.2 | PC/SC communication, SL Token generation |
| [**EMVCard.Core**](https://www.nuget.org/packages/EMVCard.Core) | 2.0.2 | EMV card reading, storage, and export |

### Installation

**Package Manager Console:**
```
Install-Package NfcReaderLib -Version 2.0.2
Install-Package EMVCard.Core -Version 2.0.2
```

**.NET CLI:**
```
dotnet add package NfcReaderLib --version 2.0.2
