...
|---------|---------|-------------|
| [**NfcReaderLib**](https://www.nuget.org/packages/NfcReaderLib) | 2.0.4 | PC/SC communication, SL Token generation |
...
```
Install-Package NfcReaderLib -Version 2.0.4
Install-Package EMVCard.Core -Version 2.0.4
```

**.NET CLI:**
```
dotnet add package NfcReaderLib --version 2.0.4
dotnet add package EMVCard.Core --version 2.0.4
