...
namespace EMVCard
{
    ...
    public class EmvTokenGenerator
    {
        ...
        /// <summary>
        /// Generate SL Token from card data asynchronously.
        /// </summary>
        /// <param name="cardData">Card data containing ICC certificate</param>
        /// <param name="pan">Primary Account Number</param>
        /// <param name="aid">Application ID</param>
        /// <returns>Token generation result</returns>
        public Task<TokenResult> GenerateTokenAsync(EmvDataParser.EmvCardData cardData, string pan, string aid)
        {
            return Task.Run(() => GenerateToken(cardData, pan, aid));
        }

        /// <summary>
        /// Generate SL Token directly from ICC certificate bytes asynchronously.
        /// </summary>
        /// <param name="certificate">ICC public key certificate</param>
        /// <returns>Token generation result</returns>
        public Task<TokenResult> GenerateTokenFromCertificateAsync(byte[] certificate)
        {
            return Task.Run(() => GenerateTokenFromCertificate(certificate));
        }
